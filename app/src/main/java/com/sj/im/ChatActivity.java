...
public class ChatActivity extends AppBaseActivity implements ChatView.OnKeyboardChangedListener, View.OnTouchListener {
                ...
                JMessageClient.getUserInfo(mTargetId, new GetUserInfoCallback() {
                    ...
                    public void gotResult(int status, String s, UserInfo userInfo) {
                        if (status == 0) {
                            ...
                            mChatView.setTitle(mTargetInfo.getDisplayName());
                        }
                    }
                });
            } else {
