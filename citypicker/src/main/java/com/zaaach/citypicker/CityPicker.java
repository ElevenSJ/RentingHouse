...
public class CityPicker {
    ...
    public CityPicker setAssetFile(String fileName){
    ...
    public void jsonShow(){
        ...
        final CityPickerDialogJsonFragment cityPickerFragment =
                CityPickerDialogJsonFragment.newInstance(enableAnim);
        cityPickerFragment.setLocatedCity(mLocation);
        cityPickerFragment.setAllCities(allCities);
        cityPickerFragment.setAssetFile(assetFileName);
