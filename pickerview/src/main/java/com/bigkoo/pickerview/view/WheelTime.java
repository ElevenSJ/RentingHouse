...
import com.bigkoo.pickerview.adapter.CustomNumericWheelAdapter;
...
public class WheelTime {
    ...
    public WheelTime(View view, Type type, ArrayList<Integer> minList) {
        super();
        this.view = view;
        this.type = type;
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        wv_mins.setAdapter(minList == null || minList.isEmpty() ? new NumericWheelAdapter(0, 59) : new CustomNumericWheelAdapter(minList));
